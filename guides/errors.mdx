...
| 422 | `FACE_TOO_SMALL` | Face bounding box under 224×224 px | Retake closer to the camera; don't downscale before sending. Or [disable the gate](/guides/image-inputs#disabling-the-minimum-face-size-gate) with `min_face_check: false` |
